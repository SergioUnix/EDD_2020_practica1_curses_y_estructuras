...
std::string ListaDoble::grafic()
{
        ...
        std::string linea6="node [width =0.8];";
        ...
        std::string primer_direccion="node1:n -> node0;";
        std::string lineafinal="}";
        std::string grafo= linea1+linea2+linea3+linea4+linea5+linea6+nodos+primer_direccion+direccion+lineafinal;
        return grafo;
